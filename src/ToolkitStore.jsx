...
export default function ToolkitStore() {
  ...
  const allProducts = [
    ...
    { id: 5, name: "Silicon soap mold", category: "Home Care", price: 10029, img: moldImg, rating: 3.8, description: ["Product Name: Silicone Soap Mold"] },
    ...
    { id: 8, name: "Brother-electric Sewing machine", category: "Craft", price: 147785, img: brosewImg, badge: "Sale", rating: 4, description: ["Product Name: Brother Electric Sewing Machine JK17B"] },
    { id: 9, name: "Professional Studio condenser microphone", category: "Music", price: 72340, img: micImg, rating: 4.2, description: ["Product Name: BM-800 Professional Recording Microphone"] },
